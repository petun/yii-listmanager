 ...
 *
 * The followings are the available columns in table 'data_list':
 * @property integer $id
...
class DataList extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, type, name, position', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return DataList the static model class
	 */
	...
	public function types() {
		return Yii::app()->controller->module->lists;
	}
